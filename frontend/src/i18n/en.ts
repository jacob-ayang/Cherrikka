...
export const en: I18nText = {
  ...
  sourceFileRemove: 'Remove',
  sourceFilesCount: 'Files',
  ...
  configPrecedenceLatest: 'Latest Source',
  configPrecedenceFirst: 'First Source',
  configPrecedenceTarget: 'Target-Matched Source',
  configPrecedenceSource: 'Selected Source',
  ...
  multiSourceAutoOnly: 'Multi-source convert requires source format set to Auto Detect',
